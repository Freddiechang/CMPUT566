...
learn to presict which features are more attractive to human. 
...
\begin{itemize}
    ...
    \item loss functions: NSS, CC, shffled AUC, AUC-Borji, and AUC-Judd (NSS and CC implementedby Shupei, all AUC methods implemented by Mehdi)
