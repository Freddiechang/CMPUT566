...
Therefore, gradients methods \cite{sundararajan2017axiomatic} will be used to determine which pixels have the most contribution to determine the focused areas.
...
Besides comparing the result with their separate performance, we would also disable or disturb the attention mechanism (creating random heat maps with similar distributions) on the trained model to infer their separate roles and cooperation in this task.
