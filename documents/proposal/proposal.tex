...
\begin{table}[t]
    ...
    \begin{tabular}{cc|cccc}
        ...
        CC(2) & Yes & 1.1595 & 0.8533 & 1.5896 & 0.6085\\
        $\text{CC}^{\star}\text{(2)}$& Yes & 1.1766 & 0.8643 & 1.5982 & 0.6111\\
    ...
    and ``CAT2000 average'' rows. The models in row ``$\text{CC}^{\star}\text{(2)}$'' are trained using learning rate $0.001$, all
    other models are trained using learning rate $0.01$.}
...
CAT2000 includes many strange types of figures but probably they cannot perfectly imitate the distribution of information in the real world. 
...
The subjects that contribute their eye movement data also cannot represent all the people in the world. Children, people with color deficiency or experts in some fields may have some special preference in their attention system.
